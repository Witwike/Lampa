(function () {
    ...
    // 3. Показ всех кнопок в карточке (ваша оригинальная функция полностью)
    ...
    // 4. НОВАЯ расширенная функция лейблов на карточках (как на первом скрине)
    ...
    // 5. Применение тем (все ваши темы)
    ...
    function startPlugin() {
        ...
        Lampa.SettingsApi.addParam({
            ...
            field: { name: 'Изменить лейблы типа', description: 'Изменить "TV" на "Сериал" и добавить расширенные лейблы' },
            onChange: function (value) {
